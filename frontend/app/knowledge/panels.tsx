...
// Panel-panel Knowledge — dipakai lintas subhalaman /knowledge/* (pattern,
// template, writeback). Diekstrak dari page.tsx monolitik saat Knowledge
// dipecah jadi submenu (satu panel = satu tanggung jawab, tanpa anchor-hash).

import { useEffect, useState } from 'react';
import { api, getSession, SkillInfo } from '@/lib/api';
...
export function TemplateKpPkpPanel() {
...
export function PatternMonitorPanel() {
...
export function WritebackPanel({ role }: { role: string }) {
