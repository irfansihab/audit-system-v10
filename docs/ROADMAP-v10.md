...
- **5.1a ⏳ Konfirmasi & bundel kriteria RIIL** (menunggu auditor) — isikan **nomor + tahun + pasal** yang kini generik: **PNBP** (PP Jenis & Tarif PNBP Komdigi utk BHP frekuensi/IPFR · PMK Piutang PNBP · PMK Penatausahaan/Penyetoran PNBP + batas waktu setor); **LK** (PMK SAKTI · PMK Bagan Akun Standar · PMK Kebijakan Akuntansi Pempus · PMK Penyusunan LK); **PIPK** (konfirmasi PMK 14/PMK.09/2017 masih berlaku / pengganti). UU & PP besar (SAP PP 71/2010, SPIP PP 60/2008, PNBP UU 9/2018) sudah pasti. Setelah bernomor → bundel dokumen ke `references/` → RAGU `kriteria` hilang.
