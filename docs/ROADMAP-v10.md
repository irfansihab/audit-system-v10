...
- **5.1c ⏳ Sisa pendukung LK (opsional, menunggu auditor)** — PMK SAKTI · BAS · Penyusunan & Penyampaian LK (nomor/versi). Standar reviu + SAP + kebijakan akuntansi inti sudah lengkap; ini pelengkap sistem/rekonsiliasi.
